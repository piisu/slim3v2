...
public class AttributeMetaDescFactory {
     ...
     *
     * @param classElement       the model class declaration
     * @param fieldElement       the field declaration
     ...
     * Handleds a field.
     *
     * @param attributeMetaDesc the attribute meta description
     * @param classElement      the model class declaration
     * @param fieldElement      the field declaration
     ...
     * @param classElement      the model class declaration
     * @param fieldElement      the field declaration
     * @param attribute         the Attribute annotation mirror
     */
     ...
     * @param classElement      the model class declaration
     * @param fieldElement      the field declaration
     * @param attribute         the annotation mirror for Attribute
     */
     ...
     * @param classElement      the model class declaration
     * @param fieldElement      the field declaration
     * @param listenerClassType the class type
     ...
     *
     * @param attributeMetaDesc  the attribute meta description
     * @param classElement       the class declaration
     * @param fieldElement       the field declaration
     * @param methodDeclarations the method declaration
     */
     ...
     *
     * @param attributeMetaDesc      the attribute mete description
     * @param classElement           the model declaration
     * @param fieldElement           the field declaration
     * @param readMethodDeclaration  the read method declaration
     * @param wirteMethodDeclaration the write method declaration
     */
     ...
     *
     * @param attributeMetaDesc      the attribute mete description
     * @param modelRefType           the model reference type
     * @param classElement           the model declaration
     * @param fieldElement           the field declaration
     * @param readMethodDeclaration  the read method declaration
     * @param writeMethodDeclaration the write method declaration
     */
     ...
     *
     * @param attributeMetaDesc      the attribute mete description
     * @param inverseModelRefType    the inverse model ref type
     * @param classElement           the model declaration
     * @param fieldElement           the field declaration
     * @param readMethodDeclaration  the read method declaration
     * @param writeMethodDeclaration the write method declaration
     ...
     * @param m                 the method declaration
     * @param attributeMetaDesc the attribute meta description
     * @param fieldElement      the field type
     * @return {@code true} if method is setter method
     */
     ...
     * @param fieldElement the field declaration
     * @param attribute    the annotation mirror for Attribute
     * @param element1     conflicted element
     * @param element2     conflicted element
     */
