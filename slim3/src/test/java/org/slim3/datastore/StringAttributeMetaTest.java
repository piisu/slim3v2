...
public class StringAttributeMetaTest {
    ...
    public void startsWith() throws Exception {
        ...
        assertThat(meta.myString.startsWith("a"), isA(StartsWithCriterion.class));
    ...
    public void endsWith() throws Exception {
        HogeMeta meta = new HogeMeta();
        assertThat(meta.myString.endsWith("a"), isA(InMemoryEndsWithCriterion.class));
    ...
    public void contains() throws Exception {
        HogeMeta meta = new HogeMeta();
        assertThat(meta.myString.contains("a"), isA(InMemoryContainsCriterion.class));
